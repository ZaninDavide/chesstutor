...
class Arrows extends Component {
  ...
  get_arrows(arrows, rotated = false){
    return arrows.map(a => {
      ...
      return <line x1={from.x} y1={from.y} x2={to.x} y2={to.y} style={{markerEnd: "url(#ArrowMarker)", strokeWidth: 2.5, stroke: "var(--arrowColor)", opacity: .4}} key={`arrow_${a.from}_${a.to}`} />
    })
  }
